...
export const ROLE_POLICIES = {
  ...
  sales_assistant_leader: { name: "销售助理组长", performanceScope: "all", goalScope: "none", businessOperations: ["全公司业绩录入与调整", "业绩账本监督"], targetResponsibilities: "无", exportPermission: "全公司业绩", forbidden: ["目标编辑与审批", "账号与组织维护"], performanceEdit: true, accountAdmin: false, organizationAdmin: false },
  ...
  hr: { name: "人事部", performanceScope: "all", goalScope: "all", businessOperations: ["全公司业务只读", "目标最终审批"], targetResponsibilities: "审批目标、签名与修改申请", exportPermission: "全公司业务", forbidden: ["业绩录入与调整", "目标金额编辑", "账号与组织维护"], performanceEdit: false, accountAdmin: false, organizationAdmin: false },
