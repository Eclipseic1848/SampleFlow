...
export const ROLE_POLICIES = {
  ...
  hr: { name: "人事部", performanceScope: "all", goalScope: "all", businessOperations: ["全公司业务只读", "目标最终审批", "记账期间关闭与更正审批", "历史订单核对审批"], targetResponsibilities: "审批目标、签名与修改申请", exportPermission: "全公司业务", forbidden: ["业绩录入与调整", "目标金额编辑", "账号与组织维护"], performanceEdit: false, accountAdmin: false, organizationAdmin: false },
